...
export interface ApiLessonChapterLessonChapter
  ...
  info: {
    displayName: 'Lesson chapter';
    pluralName: 'lesson-chapters';
    singularName: 'lesson-chapter';
  };
  options: {
  ...
  attributes: {
    ...
    lesson_video: Schema.Attribute.Relation<
      'oneToOne',
      'api::lesson-video.lesson-video'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLessonVideoLessonVideo extends Struct.CollectionTypeSchema {
  collectionName: 'lesson_videos';
  info: {
    displayName: 'Lesson video';
    pluralName: 'lesson-videos';
    singularName: 'lesson-video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    lesson_chapter: Schema.Attribute.Relation<
      ...
      'api::lesson-chapter.lesson-chapter'
    >;
    lesson_video: Schema.Attribute.Media<'videos'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lesson-video.lesson-video'
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lesson_chapters: Schema.Attribute.Relation<
      'oneToMany',
      'api::lesson-chapter.lesson-chapter'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title_image: Schema.Attribute.Media<'images'>;
    title_image_audio: Schema.Attribute.Media<'audios'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
